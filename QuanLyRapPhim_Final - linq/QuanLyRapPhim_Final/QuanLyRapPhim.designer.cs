...
namespace QuanLyRapPhim_Final
{
    ...
    partial void DeleteRap(Rap instance);
		...
		public QuanLyRapPhimDataContext() : 
				base(global::QuanLyRapPhim_Final.Properties.Settings.Default.QuanLyRapPhimConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class NhanVien : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private int _GioNghi;
		
		private int _TongGioNghi;
    ...
    partial void OnMaCVChanging(string value);
    partial void OnMaCVChanged();
    partial void OnGioNghiChanging(int value);
    partial void OnGioNghiChanged();
    partial void OnTongGioNghiChanging(int value);
    partial void OnTongGioNghiChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_GioNghi", DbType="Int NOT NULL")]
		public int GioNghi
		{
			get
			{
				return this._GioNghi;
			}
			set
			{
				if ((this._GioNghi != value))
				{
					this.OnGioNghiChanging(value);
					this.SendPropertyChanging();
					this._GioNghi = value;
					this.SendPropertyChanged("GioNghi");
					this.OnGioNghiChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TongGioNghi", DbType="Int NOT NULL")]
		public int TongGioNghi
		{
			get
			{
				return this._TongGioNghi;
			}
			set
			{
				if ((this._TongGioNghi != value))
				{
					this.OnTongGioNghiChanging(value);
					this.SendPropertyChanging();
					this._TongGioNghi = value;
					this.SendPropertyChanged("TongGioNghi");
					this.OnTongGioNghiChanged();
				}
			}
		}
